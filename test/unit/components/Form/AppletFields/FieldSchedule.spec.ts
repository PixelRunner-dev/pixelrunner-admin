...
describe('FieldSchedule.vue', () => {
  ...
  it('renders schedule component', () => {
    const wrapper = mount(FieldSchedule, { global: { mocks: i18nMock } });
  ...
  it('can be rendered multiple times', () => {
    const w1 = mount(FieldSchedule, { global: { mocks: i18nMock } });
    const w2 = mount(FieldSchedule, { global: { mocks: i18nMock } });
