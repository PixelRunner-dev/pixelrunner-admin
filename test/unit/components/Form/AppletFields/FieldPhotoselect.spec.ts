...
describe('FieldPhotoselect.vue', () => {
  ...
  it('renders photoselect component', () => {
    const wrapper = mount(FieldPhotoselect, { props: defaultProps, global: { mocks: i18nMock } });
  ...
  it('multiple instances work independently', () => {
    const w1 = mount(FieldPhotoselect, { props: defaultProps, global: { mocks: i18nMock } });
    const w2 = mount(FieldPhotoselect, {
      props: { id: 'test-field-photoselect-2' },
      global: { mocks: i18nMock }
    });
