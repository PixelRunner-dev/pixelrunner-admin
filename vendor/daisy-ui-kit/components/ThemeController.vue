...
const themeOptions =
  props.themes || props.defaultTheme
    ? { themes: props.themes || [], defaultTheme: props.defaultTheme }
    : undefined;

const { theme, effectiveTheme, themes, setTheme, cycleTheme, registerTheme, removeTheme } =
  useDaisyTheme(props.storage, themeOptions);

const availableThemes = computed(() =>
  themes.value.map((t) => (typeof t === 'string' ? t : t.theme))
);
</script>
