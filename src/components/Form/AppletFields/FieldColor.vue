...
import { Flex as DFlex, Input as DInput, Label as DLabel } from '(vendor)/daisy-ui-kit/index.ts';
...
<template>
  <div class="component--field-color">
    <DFlex
      class="relative gap-4 border border-size-field rounded-field focus-within:ring focus-within:outline-2 focus-within:outline-offset-3 bg-base-100 text-sm w-80"
    ...
    >
      ...
      <DInput
        ...
        type="color"
        ghost
        class="outline-none p-0 text-sm w-16"
        :list="`${id}-palette`"
      />
    </DFlex>
