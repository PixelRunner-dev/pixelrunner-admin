...
import { Input as DInput, LoadingSpinner as DLoadingSpinner } from '(vendor)/daisy-ui-kit/index.ts';
...
<template>
  <div class="relative" @blur="suggestionsEl?.classList.add('hidden')">
    <div
      class="relative border border-size-field rounded-field focus-within:ring focus-within:outline-2 focus-within:outline-offset-3 bg-base-100 text-sm w-80"
